...
# read in tree
tree = read.tree('/Phage/plasmidome/260707_P4Revision/tree/all.bionj.asc.newick') # tips: 436

# reading in mash data
mash_data = data.frame(read_excel('/Phage/plasmidome/260707_P4Revision/tree/260623_finalized_144_assemblies_mash_checkm_quast_noBSI.xlsx'), stringsAsFactors = F)
mash_data <- mash_data %>%
...
pts = data.frame(read_excel('/data/260616_sip_updated_meta_v2.xlsx'), stringsAsFactors = F)
pts <- pts %>%
...
#write_lines(tree$tip.label, "/Phage/plasmidome/250113_P4phagepipelinefinalizing/VIPtree/260128_tipsprefilter.txt" )


#Dropping phages that didn't pass pharokka and mapping

#tips_keep <- readLines("/VIPtree/250919_pharokkapassedphages.txt")
#tips_keep <- readLines("/Phage/plasmidome/250113_P4phagepipelinefinalizing/VIPtree/260503_succesfullymappedphages_V2.txt")
...
# 
# 
# #write_lines(tree$tip.label, "/Phage/plasmidome/250113_P4phagepipelinefinalizing/VIPtree/260128_tipspostfilter.txt" )
# 
# 
# 
...
plot_file <- file.path('/Phage/plasmidome/260707_P4Revision/', paste0(Sys.Date(), "abx_mash_phage.pdf"))
